 ...
 * - Each individual world and dimension has separate data; there are 3 separate files across:
 ...
 * - Pre-26.1 worlds are migrated automatically on first load via HandsOffMyWorldDataMigrator.
 */
...
public class HandsOffMyMarkedBlocksData extends SavedData {
    ...
    public static final SavedDataType<HandsOffMyMarkedBlocksData> TYPE = new SavedDataType<>(
            Identifier.fromNamespaceAndPath("village-pillage-tweaks", "handsoffmyblock_marked"),
